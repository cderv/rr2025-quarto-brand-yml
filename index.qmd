...
:   Options pour support spécifiques par des outils utilisant `_brand.yml`
:::
:::
:::
...
# Support spécifique Quarto

## Intégration avec les thèmes Quarto {auto-animate="true"}
...
Une fonctionnalité Quarto 1.7 qui permet de convertir des propriétés CSS en propriété Typst. 

Avantage: Style similaire entre format HTML et format Typst.
