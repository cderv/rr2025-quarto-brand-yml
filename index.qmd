...
::: {.make-smaller style='margin-top: 2em;' data-id="spec"}
[`meta`]{.hl}
:   Information de l'organization, nom de l'entreprise, URLs, etc.

    :link: [Brand.yml meta Spec](https://posit-dev.github.io/brand-yml/brand/meta.html)
:::
:::
:::
...
:   Palette de couleurs de l'image de marque de l'organisation.
    ...
    :link: [Brand.yml Color Spec](https://posit-dev.github.io/brand-yml/brand/color.html)
:::
:::
:::
...
:   Polices pour les différents éléments.
    ...
    :link: [Brand.yml Typography Spec](https://posit-dev.github.io/brand-yml/brand/typography.html)
:::
:::
:::
...
:  Logos pour l'image de marque de l'organisation.
   ...
   :link: [Brand.yml Logo Spec](https://posit-dev.github.io/brand-yml/brand/logo.html)
:::
:::
:::
...
::: {.make-smaller style='margin-top: 2em;' data-id="spec"}
[`defaults`]{.hl}
:   Options pour support spécifiques par des outils utilsant `_brand.yml`

    :link: [Brand.yml Defaults Spec](https://posit-dev.github.io/brand-yml/brand/defaults.html)
:::
:::
:::
...
A mettre à la racine du projet Quarto
...
Configuration dans `_quarto.yml` ou dans le document

::: {.r-fit-text}
::: {.bottom-pad .top-pad}
````yaml
# fichier à une place differente
