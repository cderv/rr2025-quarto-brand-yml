...
:   Information de l'organization, nom de l'entreprise, URLs, etc.
    ...
    Spec: <https://posit-dev.github.io/brand-yml/brand/meta.html>
:::
...
:   Palette de couleurs de l'image de marque de l'organisation.
    ...
    Spec: <https://posit-dev.github.io/brand-yml/brand/color.html>
:::
...
:   Polices pour les différents éléments.
    ...
    Spec: <https://posit-dev.github.io/brand-yml/brand/typography.html>
:::
...
:  Logos pour l'image de marque de l'organisation.
   ...
   Spec: <https://posit-dev.github.io/brand-yml/brand/logo.html>
:::
...
:   Options pour support spécifiques par des outils utilsant `_brand.yml`
    ...
    Spec: <https://posit-dev.github.io/brand-yml/brand/defaults.html>
:::
